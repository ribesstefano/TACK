...
class EmbeddingMixin(object):
    ...
    def save(
        ...
        Args:
            ...
            cache_dir (Optional[str]): Directory to save the embeddings. If None, uses the default cache directory.
                If the cache directory is not set, it will use the default cache directory defined as environment variable STAEDA_CACHE, if set, or: ~/.cache/staeda/
    ...
    def transform(self, **kwargs) -> Union[Dict[str, np.ndarray], np.ndarray]:
    ...
    def encode_update(self, to_encode: Union[str, List[str]], **kwargs) -> None:
        ...
        Returns:
            None: Updates the internal embeddings dictionary.
        """
        self.update(self.transform(to_encode, **kwargs))
